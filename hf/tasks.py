...
import datasets
from datasets import Dataset, interleave_datasets, get_dataset_infos, load_dataset
...
class MixtureRegistry:
    ...
    def _apply_template(self, dataset, template, map_fn=None):
        ...
        return dataset.remove_columns(set(original_columns) - {"inputs", "labels", "answer_choices"})
...
mt0_train_mixture: Dict[str, Any] = {}
xtreme_en_mixture = MixtureRegistry()
...
mt0_train_mixture["task_mixture_coreference_resolution"] = MixtureRegistry()

sglue_train_mixture.add_task("super_glue", "wsc.fixed")
xtreme_en_mixture.add_task("super_glue", "wsc.fixed")

mt0_train_mixture[
    "task_mixture_coreference_resolution"
    ].add_task("winogrande", "winogrande_xl")

# ==================================== Natural Language Inference ======================================
mt0_train_mixture["task_mixture_natural_language_inference"] = MixtureRegistry()

mt0_train_mixture[
    "task_mixture_natural_language_inference"
    ].add_task("super_glue", "cb")

mt0_train_mixture[
    "task_mixture_natural_language_inference"
    ].add_task("super_glue", "rte")
...
xtreme_en_mixture.add_task("multi_nli", None)
...
mt0_train_mixture["task_mixture_paraphrase_identification"] = MixtureRegistry()

t0_train_mixture.add_task("glue", "mrpc")
mt0_train_mixture[
    "task_mixture_paraphrase_identification"
    ].add_task("glue", "mrpc")

t0_train_mixture.add_task("glue", "qqp")
mt0_train_mixture[
    "task_mixture_paraphrase_identification"
    ].add_task("glue", "qqp")

t0_train_mixture.add_task("paws", "labeled_final")
xtreme_en_mixture.add_task("paws", "labeled_final")

# ==================================== Closed-Book QA ======================================
mt0_train_mixture["task_mixture_closed_book_qa"] = MixtureRegistry()

gpt_train_mixture.add_task("ai2_arc", "ARC-Challenge")
mt0_train_mixture["task_mixture_closed_book_qa"].add_task("ai2_arc", "ARC-Challenge")

gpt_train_mixture.add_task("ai2_arc", "ARC-Easy")
mt0_train_mixture["task_mixture_closed_book_qa"].add_task("ai2_arc", "ARC-Easy")

mt0_train_mixture["task_mixture_closed_book_qa"].add_task("kilt_tasks", "hotpotqa")

gpt_train_mixture.add_task("trivia_qa", "unfiltered")
mt0_train_mixture["task_mixture_closed_book_qa"].add_task("trivia_qa", "unfiltered")

gpt_train_mixture.add_task("web_questions", None)
mt0_train_mixture["task_mixture_closed_book_qa"].add_task("web_questions", None)

t0_train_mixture.add_task("wiki_qa", None)
mt0_train_mixture["task_mixture_closed_book_qa"].add_task("wiki_qa", None)

# ==================================== Extractive QA ======================================
mt0_train_mixture["task_mixture_extractive_qa"] = MixtureRegistry()

t0_train_mixture.add_task("adversarial_qa", "dbidaf")
mt0_train_mixture["task_mixture_extractive_qa"].add_task("adversarial_qa", "dbidaf")

t0_train_mixture.add_task("adversarial_qa", "dbert")
mt0_train_mixture["task_mixture_extractive_qa"].add_task("adversarial_qa", "dbert")

t0_train_mixture.add_task("adversarial_qa", "droberta")
mt0_train_mixture["task_mixture_extractive_qa"].add_task("adversarial_qa", "droberta")

t0_train_mixture.add_task("duorc", "SelfRC")
mt0_train_mixture["task_mixture_extractive_qa"].add_task("duorc", "SelfRC")

t0_train_mixture.add_task("duorc", "ParaphraseRC")
mt0_train_mixture["task_mixture_extractive_qa"].add_task("duorc", "ParaphraseRC")

t0_train_mixture.add_task("ropes", None)
mt0_train_mixture["task_mixture_extractive_qa"].add_task("ropes", None)

xtreme_en_mixture.add_task("squad_v2", None)

sglue_train_mixture.add_task("super_glue", "record")
mt0_train_mixture["task_mixture_extractive_qa"].add_task("super_glue", "record")

t0_train_mixture.add_task("quoref", None)
mt0_train_mixture["task_mixture_extractive_qa"].add_task("quoref", None)

t0_train_mixture.add_task("tydiqa", None)
xtreme_en_mixture.add_task("tydiqa", None)

# ==================================== Multiple-Choice QA ======================================
mt0_train_mixture["task_mixture_multiple_choice_qa"] = MixtureRegistry()

t0_train_mixture.add_task("cos_e", "v1.11")
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("cos_e", "v1.11")

t0_train_mixture.add_task("cosmos_qa", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("cosmos_qa", None)

t0_train_mixture.add_task("dream", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("dream", None)

mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("openbookqa", "main")

t0_train_mixture.add_task("qasc", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("qasc", None)

t0_train_mixture.add_task("quail", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("quail", None)

t0_train_mixture.add_task("quarel", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("quarel", None)

t0_train_mixture.add_task("quartz", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("quartz", None)

mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("race", "high")

mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("race", "middle")

t0_train_mixture.add_task("sciq", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("sciq", None)

t0_train_mixture.add_task("social_i_qa", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("social_i_qa", None)

sglue_train_mixture.add_task("super_glue", "boolq")
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("super_glue", "boolq")

sglue_train_mixture.add_task("super_glue", "multirc")
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("super_glue", "multirc")

t0_train_mixture.add_task("wiki_hop", "original")
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("wiki_hop", "original")

t0_train_mixture.add_task("wiqa", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("wiqa", None)

gpt_train_mixture.add_task("piqa", None)
mt0_train_mixture["task_mixture_multiple_choice_qa"].add_task("piqa", None)

# ==================================== Sentiment ======================================
mt0_train_mixture["task_mixture_sentiment"] = MixtureRegistry()

t0_train_mixture.add_task("amazon_polarity", None)
mt0_train_mixture["task_mixture_sentiment"].add_task("amazon_polarity", None)

t0_train_mixture.add_task("app_reviews", None)
mt0_train_mixture["task_mixture_sentiment"].add_task("app_reviews", None)

t0_train_mixture.add_task("imdb", None)
mt0_train_mixture["task_mixture_sentiment"].add_task("imdb", None)

t0_train_mixture.add_task("rotten_tomatoes", None)
mt0_train_mixture["task_mixture_sentiment"].add_task("rotten_tomatoes", None)

t0_train_mixture.add_task("yelp_review_full", None)
mt0_train_mixture["task_mixture_sentiment"].add_task("yelp_review_full", None)

# ==================================== Sentence Completion ======================================
mt0_train_mixture["task_mixture_sentence_completion"] = MixtureRegistry()

sglue_train_mixture.add_task("super_glue", "copa")
xtreme_en_mixture.add_task("super_glue", "copa")
...
gpt_train_mixture.add_task("hellaswag", None)
mt0_train_mixture["task_mixture_sentence_completion"].add_task("hellaswag", None)

# ==================================== Structure-to-Text ======================================
mt0_train_mixture["task_mixture_structure_to_text"] = MixtureRegistry()

t0_train_mixture.add_task("common_gen", None)
mt0_train_mixture["task_mixture_structure_to_text"].add_task("common_gen", None)

t0_train_mixture.add_task("wiki_bio", None)
mt0_train_mixture["task_mixture_structure_to_text"].add_task("wiki_bio", None)

#TODO: Add NER and POS Datasets here

# ==================================== Summarization ======================================
mt0_train_mixture["task_mixture_summarization"] = MixtureRegistry()

t0_train_mixture.add_task("cnn_dailymail", "3.0.0")
mt0_train_mixture["task_mixture_summarization"].add_task("cnn_dailymail", "3.0.0")

t0_train_mixture.add_task("gigaword", None)
mt0_train_mixture["task_mixture_summarization"].add_task("gigaword", None)

t0_train_mixture.add_task("multi_news", None)
mt0_train_mixture["task_mixture_summarization"].add_task("multi_news", None)

t0_train_mixture.add_task("samsum", None)
mt0_train_mixture["task_mixture_summarization"].add_task("samsum", None)

t0_train_mixture.add_task("xsum", None)
mt0_train_mixture["task_mixture_summarization"].add_task("xsum", None)

# ==================================== Topic Classification ======================================
mt0_train_mixture["task_mixture_topic_classification"] = MixtureRegistry()

t0_train_mixture.add_task("ag_news", None)
mt0_train_mixture["task_mixture_topic_classification"].add_task("ag_news", None)

t0_train_mixture.add_task("dbpedia_14", None)
mt0_train_mixture["task_mixture_topic_classification"].add_task("dbpedia_14", None)

t0_train_mixture.add_task("trec", None)
mt0_train_mixture["task_mixture_topic_classification"].add_task("trec", None)

# ==================================== Word Sense Disambiguation ======================================
mt0_train_mixture["task_mixture_word_sense_disambiguation"] = MixtureRegistry()

sglue_train_mixture.add_task("super_glue", "wic")
mt0_train_mixture["task_mixture_word_sense_disambiguation"].add_task("super_glue", "wic")

# # ==================================== OPUS100 ======================================
# opus100_train_mixture = MixtureRegistry()
# OPUS100_LANGS = {
#     'en-tk': 0.003739976949602965,
...
#     opus100_train_mixture.add_task(
#         "opus100",
#         ori_lang,
#         None
#         )
...
training_mixtures = {
    "t0_train": MixtureRegistry(mixture=[t0_train_mixture]),
    "gpt_train": MixtureRegistry(mixture=[gpt_train_mixture]),
    "sglue_train": MixtureRegistry(mixture=[sglue_train_mixture]),
    "t0_plus_train": MixtureRegistry(mixture=[t0_train_mixture, gpt_train_mixture]),
    "t0_plus_plus_train": MixtureRegistry(mixture=[t0_train_mixture, gpt_train_mixture, sglue_train_mixture]),
}

# "t0_train_plus_opus": MixtureRegistry().add_task(t0_train_mixture+opus100_train_mixture),
